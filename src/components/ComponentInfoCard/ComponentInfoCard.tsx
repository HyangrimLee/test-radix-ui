...
export default function ComponentInfoCard(props: ComponentInfoCardProps) {
    return (
        <Link href={props.href} underline="none">
            <Card size="1">
                <Flex gap="3" align="start" minHeight="76px" maxHeight="64px" pb="2" overflowY="auto">
                    <Avatar
                        size="3"
                        radius="full"
                        color="lime"
                    ...
                    />
                    <Box>
                        <Text as="div" size="2" weight="bold">{props.title}</Text>
                        <Text as="div" size="2" color="gray">{props.description}</Text>
                    </Box>
                </Flex>
            </Card>
        </Link>
