...
export default function AvatarDemo() {
  return (
    <>
      <PageTitle title="Avatar" info="사용자의 프로필 사진이나 아바타를 표시하는 컴포넌트입니다." />
      <Box width="100%" height="calc(100dvh - 134px)" overflow="hidden" style={{ backgroundColor: "var(--accent-2)", padding: "var(--space-6)" }}>
            <Flex gap="2">
